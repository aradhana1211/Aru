          ...
          <div class="page-content container container-plus">
              ...
              <form autocomplete="off" class="border-t-3 brc-blue-m2">
                ...
                <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed dtr-table">
                  ...
                  <tbody class="pos-rel">
                   ...
                   <?php $sn=1; $sql = mysqli_query($con, "SELECT * FROM brand ORDER BY id DESC"); 
			while($rows = mysqli_fetch_array($sql)) { ?>
                    ...
                    <tr class="d-style bgc-h-default-l4">
                      ...
                      <td><?php
                      $sqlone = mysqli_query($con, "SELECT * FROM category WHERE cat_id = '".$rows["category_id"]."'");
                      $cat = mysqli_fetch_array($sqlone);
                      echo $cat["cat_name"];?> </td>
                      <td text-95 text-secondary-d1>  <?php echo $rows["about_us"];?> </td>
                      ...
                      <td class="align-middle">
                        ...
                        <span>
                            <a data-rel="tooltip" title="Delete" href="delete.php?brand_id=<?php echo $rows["id"];?>" >
                                <i class="fa fa-trash text-120" ></i>
                            </a>
                        </span>
                        <span>
                            <a data-rel="tooltip"  title="" href="brandadd.php?brand_id=<?php echo $rows["id"];?>" data-original-title="Edit">
                                <i class="fa fa-edit text-blue-m1 text-120" ></i>
                            </a>
                        </span>
                        <span>
                            <a data-rel="tooltip"  title="" href="viewuser.php?user_id=<?php echo $rows["id"];?>" data-original-title="View">
