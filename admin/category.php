...
extract($_POST);
$resultCHK =mysqli_query($con,"SELECT cat_name FROM category WHERE cat_name='$cat_name'");
	 ...
	 ?>
              ...
              <form autocomplete="off" class="border-t-3 brc-blue-m2">
                ...
                <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed dtr-table">
                  ...
                  <tbody class="pos-rel">
                   ...
                   <?php $sn=1; $sql = mysqli_query($con, "SELECT * FROM category ORDER BY cat_name ASC"); 
			while($rows = mysqli_fetch_array($sql)) { ?>
                    ...
                    <tr class="d-style bgc-h-default-l4">
                      ...
                      <td class="text-grey">
                         <img src="../img/cat_img/<?php echo $rows["cat_image"];?>" height=50 width=50>
                      </td>
                      ...
                      <td class="text-grey">
					   <?php echo mysqli_num_rows(mysqli_query($con,"SELECT * FROM products WHERE pro_cat='".$rows["cat_id"]."'"));
?>
                      </td>
                      ...
                      <td>
                       <?php echo $rows["cat_desc"];?>
                      </td>

                      <td class="align-middle">
                        <span>
                            <a data-rel="tooltip" data-action="edit" title="Edit" href="#" >
                                <i class="fa fa-edit text-blue-m1 text-120" onclick="myFunction('<?php echo $rows["cat_id"];?>','<?php echo $rows["cat_image"];?>','<?php echo $rows["cat_name"];?>','<?php echo $rows["cat_status"];?>','<?php echo $rows["cat_desc"];?>')" ></i>
                            </a>
                        </span>
                        <span>
                            <a onclick="return confirm('Are you sure want to delete this?');" data-rel="tooltip" title="Delete" href="delete.php?cat_id=<?php echo $rows["cat_id"];?>" >
                  ...
                  <div class="modal-body text-center py-0">
                    ...
                    <form autocomplete="off" class="form-row mt-45" action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group col-12 mb-3">
                        ...
                        <input placeholder="Category Image" name="uploadfile" type="file" id="file_pic" accept="image/png"  class="form-control pr-4 shadow-none radius-1" onchange="checkPhoto(this)"  >
