              ...
              <form autocomplete="off" class="border-t-3 brc-blue-m2">
                ...
                <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed dtr-table">
                  ...
                  <tbody class="pos-rel">
                   ...
                   <?php $sn=1; $sql = mysqli_query($con, "SELECT * FROM buy_business"); 
			while($rows = mysqli_fetch_array($sql)) { ?>
                    ...
                    <tr class="d-style bgc-h-default-l4">
                      ...
                      <td class="align-middle">
                        ...
                        <span>
                            <a onclick="return confirm('Are you sure want to delete this?');" data-rel="tooltip" title="Delete" href="delete.php?buy_business=<?php echo $rows["id"];?>" >
