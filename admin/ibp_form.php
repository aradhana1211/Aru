...
<html>
      ...
      <label>(Institutions attended post high school)</label>
        ...
        <div class="col-sm-4" id="ln">
         ...
         <input type="nummber" name="year2" id="year1" class="form-control"/>
             ...
             <input type="radio" name="ibp_program" value="email/sms">Email/SMS
              <input type="radio" name="ibp_program" value="facebook">Facebook
              <input type="radio" name="ibp_program" value="instagram">Instagram
              <input type="radio" name="ibp_program" value="wordofmouth">Word of mouth
              <input type="radio" name="ibp_program" value="newspaper">Newspaper
             </div>
  ...
  <div class="row"><br>
        ...
        <div class="col-sm-3">
           <div class="form-group">
         <label>From</label> 
         <input type="date" name="from1" id="from" class="form-control" required="" />
        ...
        <div class="col-sm-3">
           <div class="form-group">
         <label>From</label> 
         <input type="date" name="from2" id="from1" class="form-control" required="" />
        ...
        <div class="col-sm-4">
           <div class="form-group">
         <label> To</label>
         <input type="date" name="to2" id="to1" class="form-control"  />
