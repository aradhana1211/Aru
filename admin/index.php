   ...
   $status='Duplicate Category Name.';
    ...
    if(in_array($fileType, $allowTypes)){ 
        ...
        if(move_uploaded_file($_FILES['uploadfile']['tmp_name'], $targetFilePath)){ 
          mysqli_query($con,"insert into category(cat_name,cat_image,cat_status)values ('$cat_name','$uploadfile','$cat_status','$cat_desc')");
			...
			while($rows = mysqli_fetch_array($sql)) { ?>
                    ...
                    <tr class="d-style bgc-h-default-l4">
                      ...
                      <td class="align-middle">
                        ...
                        <span>
                            <a data-rel="tooltip" title="Delete" href="delete.php?cat_id=<?php echo $rows["cat_id"];?>" >
