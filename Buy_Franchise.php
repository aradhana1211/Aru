<?php include("header.php");
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2> Buy A Franchise </h2>
							<ol class="breadcrumb highlightlinks">
								<li> <a href="index.php">
							Home
						</a> </li>
								<li class="active">Buy A Franchise</li>
							</ol>
						</div>
					</div>
				</div>
        ...
        <p class="text-green h3" style="color: #152f49;">Buying a Franchise is one of the best life changing decisions to enter Business Market.</p>
      </section>
<br/>
<br/>
      <section class="bg-light" style=" background-color: #fff">
        <div class="row flex no-gutters">
             <div class="col-lg-6 py-5 px-5" style="border-right: 10px solid #152f49;padding-left: 5%;">  
              <h3 class="text-green mb-4 font-ng-b">Franmax India Pvt.Ltd Has Expertise in it.</h3>
              
              <p class="mb-2"></p><p>Franmax India is a franchise consulting service for people looking for a more efficient and effective way to research the world of franchising before making an investment into a franchise.Franmax India represents almost 500 franchises and business opportunities from all different industries and investment levels.  
    
                  <br/><br/><b>Our concept makes us unique. Our expertise makes us the best. Select the Category and Investment Range and we will have your back </b></p><p class="mb-1"></p>
            ...
            <div class="col-lg-6 py-5 px-5 aboutText">
              <div class="bg-white text-left" style="border-right: 20px solid #152f49;margin-left: 18%; -webkit-box-shadow: -5px 5px 8px 1px rgba(0,0,0,0.5); box-shadow: -5px 5px 8px 1px rgba(0,0,0,0.5); padding: 50px; max-width: 400px;">
                <p class="text-green font-ng-b mb-5" style="font-size: 30px; line-height: 40px;">Considering Buying A Franchise?</p>
                <img src="images/click_here.gif" height="50"  width="150"/>
                <button type="button" class="btn btn-lg" data-toggle="modal" data-target="#myModal2" style="background-color: #152f49;color: #fff;">BUY A FRANCHISE</button>
      <!-- Modal -->
      <!-- Modal -->
  <!-- Modal -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" style="align-content: center;">BUY A FRANCHISE</h4>
...
<br/>
	   ...
	   <section class="page-content sec-step-list">
			...
			<div class="container">
                ...
                <p style="color: #152f49;">Many additional questions may arise during the buying process. Please do not hesitate to have us explain in detail any portion of this process. You will discover that, with Franmax India’s assistance, you can have a successful experience purchasing and owning well Known Franchise Outlet.</p>
<br/>
			<h4><p class="fs-lg text-center"><strong> Franmax India Pvt. Ltd. will find the right Brand for you based on your given Information in Buying a Franchise.</strong></p></h4>	
...
<br/>
      <section class="page-content sec-step-list">
			...
			<div class="container">
                ...
                <p style="color: #152f49;">Franmax India has been a mainstay in the Franchise industry, specializing in Franchise sales. We focus on all industry to find the right seller. This means faster results for you. Our Partners are some of the most sophisticated and experienced in the industry. Many partners have owned businesses and can relate to your specific needs. Our service, dedication and drive is your guarantee that if you are prepared to buy a franchise, we are ready to buy it for you.</p>
<br/>
			<h4><p class="fs-lg text-center"><strong>Let Franmax India be the right advisor to help you buy a Franchise each step of the way.</strong></p></h4>	
