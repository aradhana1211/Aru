...
$cat_name = mysqli_real_escape_string($con,$_GET["cat_name"]);
$pro_cat = mysqli_real_escape_string($con,$_GET["pro_cat"]);
?>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2><?php echo $cat_name;?> Products</h2>
						...
						<div class="col-sm-12" id="table_view" style="display:block;">
							<div class="table-responsive">
								<table class="table_template darklinks" id="timetable">
									...
									<?php $sql2 = mysqli_query($con, "SELECT * FROM products WHERE pro_status='Active' AND pro_cat=$pro_cat "); 
